...
public class TestResources {
    ...
    public static final File MOUSE_TEST_DATASET     = new File(TESTING_MOUSE_FOLDER.getAbsolutePath() + SLASH + UNIT_TEST_FOLDERNAME, MOUSE + Io.SAVE_FILE_EXTENSION);
    public static final File PIG_TEST_DATASET       = new File(TESTING_PIG_FOLDER.getAbsolutePath()   + SLASH + UNIT_TEST_FOLDERNAME, PIG   + Io.SAVE_FILE_EXTENSION);
    public static final File ROUND_TEST_DATASET     = new File(TESTING_ROUND_FOLDER.getAbsolutePath() + SLASH + UNIT_TEST_FOLDERNAME, ROUND + Io.SAVE_FILE_EXTENSION);
    
    public static final File MULTIPLE1_TEST_DATASET =  new File(TESTING_MULTIPLE_BASE_FOLDER.getAbsolutePath() + SLASH + UNIT_TEST_FOLDERNAME, MULTIPLE1 + Io.SAVE_FILE_EXTENSION);
    public static final File MULTIPLE2_TEST_DATASET =  new File(TESTING_MULTIPLE_BASE_FOLDER.getAbsolutePath() + SLASH + UNIT_TEST_FOLDERNAME, MULTIPLE2 + Io.SAVE_FILE_EXTENSION);
    
    
    public static final File MOUSE_CLUSTERS_DATASET = new File(TESTING_MOUSE_CLUSTERS_FOLDER.getAbsolutePath() + SLASH + UNIT_TEST_FOLDERNAME, MOUSE + WITH_CLUSTERS +Io.SAVE_FILE_EXTENSION);
    public static final File PIG_CLUSTERS_DATASET   = new File(TESTING_PIG_CLUSTERS_FOLDER.getAbsolutePath() + SLASH + UNIT_TEST_FOLDERNAME, PIG   + WITH_CLUSTERS +Io.SAVE_FILE_EXTENSION);
    public static final File ROUND_CLUSTERS_DATASET = new File(TESTING_ROUND_CLUSTERS_FOLDER.getAbsolutePath() + SLASH + UNIT_TEST_FOLDERNAME, ROUND + WITH_CLUSTERS +Io.SAVE_FILE_EXTENSION);
    
    public static final File MOUSE_SIGNALS_DATASET  = new File(TESTING_MOUSE_SIGNALS_FOLDER.getAbsolutePath()  + SLASH + UNIT_TEST_FOLDERNAME, MOUSE + WITH_SIGNALS + Io.SAVE_FILE_EXTENSION);
    public static final File PIG_SIGNALS_DATASET    = new File(TESTING_PIG_SIGNALS_FOLDER.getAbsolutePath()    + SLASH + UNIT_TEST_FOLDERNAME, PIG   + WITH_SIGNALS + Io.SAVE_FILE_EXTENSION);
    public static final File ROUND_SIGNALS_DATASET  = new File(TESTING_ROUND_SIGNALS_FOLDER.getAbsolutePath()  + SLASH + UNIT_TEST_FOLDERNAME, ROUND + WITH_SIGNALS + Io.SAVE_FILE_EXTENSION);
    
    public static final File MULTIPLE_SOURCE_1_DATASET  = new File(TESTING_MULTIPLE_BASE_FOLDER.getAbsolutePath()  + SLASH + UNIT_TEST_FOLDERNAME, MULTIPLE1+Io.SAVE_FILE_EXTENSION);
    public static final File MULTIPLE_SOURCE_2_DATASET  = new File(TESTING_MULTIPLE_BASE_FOLDER.getAbsolutePath()  + SLASH + UNIT_TEST_FOLDERNAME, MULTIPLE2+Io.SAVE_FILE_EXTENSION);
