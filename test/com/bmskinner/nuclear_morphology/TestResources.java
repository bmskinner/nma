...
public class TestResources {
    ...
    public static final String MOUSE_TEST_DATASET     = TESTING_MOUSE_FOLDER+UNIT_TEST_FOLDERNAME+"Mouse"+Io.SAVE_FILE_EXTENSION;
    public static final String PIG_TEST_DATASET       = TESTING_PIG_FOLDER+UNIT_TEST_FOLDERNAME+"Pig"+Io.SAVE_FILE_EXTENSION;
    public static final String ROUND_TEST_DATASET     = TESTING_ROUND_FOLDER+UNIT_TEST_FOLDERNAME+"Round"+Io.SAVE_FILE_EXTENSION;
    
    public static final String MOUSE_SIGNALS_DATASET  = TESTING_MOUSE_SIGNALS_FOLDER+UNIT_TEST_FOLDERNAME+"Mouse_with_signals"+Io.SAVE_FILE_EXTENSION;
    
    public static final String MULTIPLE_SOURCE_1_DATASET  = TESTING_MULTIPLE_BASE_FOLDER+UNIT_TEST_FOLDERNAME+"Multiple_source_1"+Io.SAVE_FILE_EXTENSION;
    public static final String MULTIPLE_SOURCE_2_DATASET  = TESTING_MULTIPLE_BASE_FOLDER+UNIT_TEST_FOLDERNAME+"Multiple_source_2"+Io.SAVE_FILE_EXTENSION;
