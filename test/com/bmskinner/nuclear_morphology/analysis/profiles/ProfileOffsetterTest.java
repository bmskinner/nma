...
import com.bmskinner.nuclear_morphology.analysis.profiles.ProfileOffsetter;
...
public class ProfileOffsetterTest {
    ...
    @Test
    public void testProfileOffsetterWithNullArgument() {
        exception.expect(IllegalArgumentException.class);
        ProfileOffsetter p = new ProfileOffsetter(null);
    }
