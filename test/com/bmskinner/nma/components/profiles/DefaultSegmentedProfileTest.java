...
public class DefaultSegmentedProfileTest {
	...
	@Before
	public void setUp() throws SegmentUpdateException {
		sp = makeTestProfile();
	}

	/**
	 * Create test segments in a linked list Segments run 10-20-45-89-10
	 * 
	 * @return
	 * @throws ProfileException
	 * @throws SegmentUpdateException
	 */
	private List<IProfileSegment> makeTestSegments()
			throws SegmentUpdateException {
	 ...
	 * @throws ProfileException
	 */
	private ISegmentedProfile makeTestProfile() throws SegmentUpdateException {
	...
	/**
	 * Test that a profile cannot be created when a source IProfile is paired with a
	 * list of segments from a different length profile.
	 * 
	 * @throws ProfileException
	 */
	@Test
	public void testSegmentedFloatProfileIProfileListOfIBorderSegmentExceptsOnMismatchedProfileAndList()
			throws SegmentUpdateException {
		List<IProfileSegment> list = makeTestSegments();
	...
	public void testSegmentedFloatProfileISegmentedProfile()
			throws IndexOutOfBoundsException, SegmentUpdateException {
		ISegmentedProfile result = new DefaultSegmentedProfile(sp);
		assertEquals(sp, result);
	}

	/**
	 * Test that a segmented profile created from an IProfile has one default
	 * segment
	 * 
	 * @throws ProfileException
	 */
	@Test
	public void testSegmentedFloatProfileIProfile() throws SegmentUpdateException {
		IProfile profile = new DefaultProfile(10, 100);
		ISegmentedProfile p = new DefaultSegmentedProfile(profile);
		assertEquals(1, p.getSegmentCount());
		assertEquals("Single segment should have default id", IProfileCollection.DEFAULT_SEGMENT_ID,
				p.getSegments().get(0).getID());
	}
	 ...
	 */
	@Test
	public void testSegmentedFloatProfileFloatArray() throws SegmentUpdateException {
	 ...
	 */
	@Test
	public void testConstructorCopiesSegmentState() throws SegmentUpdateException {
	...
	@Test
	public void testGetSegmentIDsReturnsEmptyListWhenNoSegments() throws SegmentUpdateException {
		sp.clearSegments();
	...
	@Test
	public void testGetSegmentsReturnsSingleItemListAfterClearing() throws SegmentUpdateException {
		sp.clearSegments();
	...
	@Test
	public void testHasSegments() throws SegmentUpdateException {
		assertTrue(sp.hasSegments());
		sp.clearSegments();
		assertEquals(1, sp.getSegmentCount());
	}
	...
	@Test
	public void testProfileIsCreatedWhenOnlyOneSegment() throws SegmentUpdateException {
