...
public class DatasetSegmentationMethodTest extends AbstractProfileMethodTest {
	...
	/**
	 * Test multiple identical cells segmentation, with the same (zero) border
	 * offset
	 * 
	 * @throws Exception
	 */
	...
	/**
	 * Test multiple identical cells segmentation, with the same (fixed) border
	 * offset
	 * 
	 * @throws Exception
	 */
	...
	/**
	 * This specific dataset caused an error during development. This test exists
	 * just to confirm that the error is gone.
	 * 
	 * @throws Exception
	 */
	@Test
	public void testSegmentationIsIndependentOfCellCountInVaryingDatasetWithKnownError()
			throws Exception {
	...
	/**
	 * Test that increasing numbers of varying cells does not affect segment
	 * fitting. The number of segments may change in variable dataset, since the
	 * median may become distorted, but any segments found should be propogated to
	 * the cells.
	 * 
	 * This test ranges from variation of zero (identical cells) to 20 (highly
	 * variable dataset) across up to 50 cells.
	 * 
	 * @throws Exception
	 */
	@Test
	 ...
	 * Test that increasing numbers of varying cells does not affect segment
	 * fitting. The number of segments may change in variable dataset, since the
	 * median may become distorted, but any segments found should be propagated to
	 * the cells.
	 * 
	 * This test ranges from variation of zero (identical cells) to 20 (highly
	 * variable dataset) across up to 50 cells.
	...
	/**
	 * A perfectly round cell will not be segmentable. Test that this does not
	 * impair the positioning of the RP, or the ability to assign the single default
	 * segment.
	 * 
	 * @throws Exception
	 */
