 ...
 *
 */
public class OpenBorderSegment implements IProfileSegment {
    ...
    private transient IProfileSegment prevSegment = null;
    private transient IProfileSegment nextSegment = null;
    ...
    public OpenBorderSegment(Element e) {
     ...
     * @param n
     */
    public OpenBorderSegment(IProfileSegment n) {
        this.uuid = n.getID();
    ...
    public List<IProfileSegment> getMergeSources() {
        List<IProfileSegment> result = new ArrayList<IProfileSegment>();
     ...
     */
    @Override
    public void addMergeSource(IProfileSegment seg) {
...
//    		s.offset(offset);
    ...
    @Override
    public void setNextSegment(IProfileSegment s) {
        if (s == null) {
    ...
    @Override
    public void setPrevSegment(IProfileSegment s) {
