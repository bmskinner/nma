...
public class CellCollection implements ICellCollection {
    ...
    /*
     * Cache the number of shared cells with other datasets. The UUID is the
     * other dataset ID, and the int is the number of shared cells
     */
     ...
     * 
     * @param path
     *            the path to the cell (uses the path-and-number format)
     * @return
    ...
    /**
     * Get the path lengths of the nuclei in this collection as an array
     * 
     * @return
     * @throws Exception
     */
    ...
    /**
     * Fetch all the cells in the collection that are not members of the given
     * collection
     * 
     * @param collection
     * @return
    ...
    private double getMedianStatistic(PlottableStatistic stat, MeasurementScale scale, UUID signalGroup, UUID segId)
            throws Exception {
    ...
    // public double getMedianStatistic(PlottableStatistic stat,
    ...
    private double[] getSegmentStatistics(SegmentStatistic stat, MeasurementScale scale, UUID id) throws Exception {
        ...
        double[] result = getNuclei().parallelStream().mapToDouble(n -> {
        ...
        Arrays.sort(result);
        return result;
        // SegmentStatisticFetchingTask task = new
        // SegmentStatisticFetchingTask(getNucleusArray(),
        // stat,
        // scale,
        // id);
        // return task.invoke();
    ...
    // DecimalFormat df = new DecimalFormat("#.##");
    // CellCollection subCollection = new CellCollection(this,
    ...
    public int hashCode() {
        ...
        result = prime * result + ((mappedCollection == null) ? 0 : mappedCollection.hashCode());
        ...
        result = prime * result + ((profileCollections == null) ? 0 : profileCollections.hashCode());
    ...
    @Override
    public double[] getMedianStatistics(PlottableStatistic stat, String component, MeasurementScale scale) {
        warn("Unimplemented method in " + this.getClass().getName());
        return null;
    }

    @Override
    public double[] getMedianStatistics(PlottableStatistic stat, String component, MeasurementScale scale, UUID id) {
        warn("Unimplemented method in " + this.getClass().getName());
        return null;
    }
