...
public interface ChartOptions extends DisplayOptions {
	...
	/**
	 * Check if individual profiles should be displayed on a single dataset profile
	 * chart, or if profiles should be hidden in favour of median and IQR range
	 * shaded in the dataset colour
	 * 
	 * @return
	 */
	...
	/**
	 * Check if dataset annotations such as segment names, segment boundary lines
	 * 
	 * @return
	 */
