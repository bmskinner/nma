...
public interface ImagePainter {
	...
	/**
	 * Paint the object in this painter with any decorations
	 * and return an image of the desired dimensions
	...
	/**
	 * Return an image of the desired dimensions containing just
	 * the base object image without decorations.
	 * @param isOriented is the component oriented
	 * @param w the max width of the output image
	 * @param h the max height of the output image
	 * @return
