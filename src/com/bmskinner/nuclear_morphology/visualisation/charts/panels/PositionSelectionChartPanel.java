...
public class PositionSelectionChartPanel extends ExportableChartPanel {
	...
	public synchronized void setChart(final JFreeChart chart) {
		...
		if (overlayRectangle != null) {
			...
			LOGGER.finest("Restoring rectangle overlay midpoint to " + newXPosition + ": "
					+ overlayRectangle.getXMinValue() + " - " + overlayRectangle.getXMaxValue());
//			fireSignalChangeEvent("UpdatePosition");
	...
	/**
	 * Set the width of the rectangle overlay if present, as a percent of the total
	 * x-range
	 * 
...
//		fireSignalChangeEvent("UpdatePosition");
	 ...
	 * @see com.bmskinner.nuclear_morphology.visualisation.charts.overlays.RectangleOverlayObject
	 */
