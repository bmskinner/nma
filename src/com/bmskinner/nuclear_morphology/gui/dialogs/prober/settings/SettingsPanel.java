...
public abstract class SettingsPanel extends JPanel
    ...
    /**
     * Used to prevent OptionsChangeEvents firing while panel is updating
     * settings to match attached options
     */
    ...
    /**
     * Add the given panel as a subpanel. Updates to this panel will cause the
     * sub panel to update also. OptionsChangeEvents from subpanels will be
     * passed upwards.
     * 
     * @param panel
     */
    ...
    /**
     * Test if the given panel is a sub panel of this or one of the sub-panels
     * of this panel.
     * 
     * @param panel
     *            the panel to test
