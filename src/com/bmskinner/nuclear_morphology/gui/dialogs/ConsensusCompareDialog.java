...
/**
 * A dialog window allowing comparisons between the consensus nuclei of multiple
 * collections.
 * 
 * @author ben
 *
...
public class ConsensusCompareDialog extends LoadingIconDialog implements ActionListener, ChangeListener, ItemListener {
    ...
    private JPanel createHeader() {
        ...
        SpinnerNumberModel maxRatioModel = new SpinnerNumberModel(maxRatio, 0, 10, 0.01);
    ...
    private void runComparison() {
        ...
        if (one.getCollection().hasConsensus() && two.getCollection().hasConsensus()) {
            ...
            try {
                ...
                ChartOptions options = new ChartOptionsBuilder().setShowAnnotations(showAnnotations)
                        .setShowMeshFaces(showFaces).setShowMeshEdges(showEdges).build();
