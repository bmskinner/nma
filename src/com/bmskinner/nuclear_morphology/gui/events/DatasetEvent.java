...
public class DatasetEvent extends EventObject {
	...
	/**
	 * Clear charts containing the associated datasets from caches, and recreate
	 * them.
	 */
	public static final String RECACHE_CHARTS = "Refresh caches"; // signal the chart cache should be refreshed for
																	// given datasets

	/**
	 * Clear charts containing the associated datasets from caches, but do not
	 * recreate them.
	 */
	 ...
	 * @param source        the source of the datasets
	 * @param message       the instruction on what to do with the datasets
	 * @param sourceName    the name of the object or component generating the
	 *                      datasets
