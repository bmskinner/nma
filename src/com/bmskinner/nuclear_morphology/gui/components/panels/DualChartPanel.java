...
//	}
//
//	protected synchronized void fireSegmentEvent(UUID id, int index) {
//		SegmentStartIndexUpdateEvent e = new SegmentStartIndexUpdateEvent(this, activeDataset(), id, index);
//
//		for (Object l : listeners) {
//			((SegmentEventListener) l).segmentStartIndexUpdateEventReceived(e);
//		}
...
//		for (Object l : listeners) {
//			((SegmentEventListener) l).segmentStartIndexUpdateEventReceived(event);
//		}
//	}
//
//	@Override
