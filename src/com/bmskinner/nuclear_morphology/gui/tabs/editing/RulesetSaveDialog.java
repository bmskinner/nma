...
/**
 * Allows new or modified rulesets to be saved against a tag
 * 
 * @author ben
 *
 */
...
public class RulesetSaveDialog extends SettingsDialog {
	...
	/**
	 * Create a rule set collection containing only the selected tags from the
	 * custom collections
	 * 
	 * @return
	 */
	...
	public class RuleSetPanel extends JPanel {
		...
		private final OrientationMark oldTag;

		public RuleSetPanel(String collectionName, OrientationMark t) {
