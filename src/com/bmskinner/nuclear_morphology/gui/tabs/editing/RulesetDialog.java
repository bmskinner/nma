...
public class RulesetDialog extends LoadingIconDialog implements TreeSelectionListener, ListSelectionListener {
	...
	/**
	 * Create the panel to display the points in the dataset
	 * 
	 * @return
	 */
	...
	/**
	 * Create the tree of rulesets for a given point
	 */
	...
	private JPanel createButtonPanel() {
		...
		importButton.addActionListener(e -> {
			try {
				File f = InputSupplier.getDefault().requestFile(Labels.EditingBorderTags.RULESET_DIALOG_SELECT_FILE,
						dataset.getSavePath().getParentFile(), "xml", "XML file");
	 ...
	 * 
	 * @param tag        the tag
	 * @param collection the collection the tag is within. Use
	 *                   {@link IAnalysisDataset::getName} to use the current
	 *                   dataset.
	 * @return
	 */
	...
	/**
	 * Fetch the rulesets for the given tag, whether in the dataset or unsaved
	 * custom rulesets
	 * 
	 * @param t          the tag to fetch
	 * @param collection the collection to use. Use
	 *                   {@link IAnalysisDataset::getName} to use the current
	 *                   dataset.
...
//                fireInterfaceEvent(InterfaceMethod.RECACHE_CHARTS);
	...
	/**
	 * Give a tag, create the boolean chart showing the points identified by the
	 * tag's rulesets, either in the dataset or unsaved custom
	 * 
