...
public class RuleSetBuildingDialog extends LoadingIconDialog {
	...
	private static final Logger LOGGER = Logger.getLogger(RuleSetBuildingDialog.class.getName());
    ...
    private void addRuleSet() {
        ...
        // Add a panel to the main panel with a profile type, and button to add
        // a rule
            ...
            try {
                ...
                for (JComponent component : components) {
                    ...
                    if (component instanceof JSpinner) {
                        ...
                        double value = ((SpinnerNumberModel) ((JSpinner) component).getModel()).getNumber()
                                .doubleValue();
                        values.add(value);
                    }
