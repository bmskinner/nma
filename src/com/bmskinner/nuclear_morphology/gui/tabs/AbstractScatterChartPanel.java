...
import com.bmskinner.nuclear_morphology.visualisation.datasets.tables.ScatterTableDatasetCreator;
...
//		getDatasetEventHandler().fireDatasetEvent(DatasetEvent.ADD_DATASET);
	}
