...
public class CellViewModel {
	...
	/**
	 * Swap a cell with a new version of the same cell. Used in the resegmentation
	 * dialog to update the active cell without triggering a view update before the
	 * dialog closes.
	 * 
