...
public class OutlineDatasetCreator extends AbstractDatasetCreator<ChartOptions> {
	 ...
	 * @throws ChartDatasetCreationException 
	 */
	private OutlineDataset<CellularComponent> addNonSegmentedOutline(ComponentOutlineDataset<CellularComponent> ds, Comparable seriesKey) throws ChartDatasetCreationException{
