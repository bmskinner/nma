...
public class NuclearSignalChartFactory extends AbstractChartFactory {
    ...
    public JFreeChart createShellChart() {
        ...
        JFreeChart chart = ChartFactory.createBarChart(null, "Outer <--- Shell ---> Interior", "Percent of signal",
                list.get(0));
        ...
        for (CategoryDataset ds : list) {
            ...
            for (int i = 0; i < ds.getColumnCount(); i++) {
                ...
                for (int j = 0; j < ds.getRowCount(); j++) {
                    ...
                    // colour = ColourSelecter.getTransparentColour(colour,
                    // true, 128); // bars must be see through
                    ...
                    try {
                        ...
                        colour = d.getCollection().getSignalGroup(signalGroup).hasColour()
                                ...
                                // ?
                                // ColourSelecter.getTransparentColour(d.getCollection().getSignalGroup(signalGroup).getGroupColour(),
                                // true, 128)
                                : colour;
     ...
     * 
     * @param dataset
     *            the AnalysisDataset to use to draw the consensus nucleus
     * @param signalCoMs
     *            the dataset with the signal centre of masses
     * @return
     * @throws Exception
     */
