...
public class ViolinCategoryDataset extends ExportableBoxAndWhiskerCategoryDataset {
     ...
     * @param columnKey
     */
    private void addProbabilityRange(@NonNull Range r, @NonNull Comparable<?> rowKey, @NonNull Comparable<?> columnKey) {
    ...
    protected void addProbabilities(double[] values, Comparable<?> rowKey, Comparable<?> columnKey) {
    ...
    /**
     * Calculate the probabilities at set intervals along the range of the data. The intervals
     * by default are {@code range / STEP_SIZE}.
     * @param list
     * @param rowKey
     * @param colKey
     */
