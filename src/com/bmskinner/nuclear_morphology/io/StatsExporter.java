...
public class StatsExporter implements Exporter {
    ...
    // }
    //
    // public static void exportNuclearStats(ICellCollection collection, String
    // filename) throws Exception {
    //
    // TableExporter nuclearStats = new
    // TableExporter(collection.getFolder()+File.separator+collection.getOutputFolderName());
    // nuclearStats.addColumn("AREA",
    // collection.getMedianStatistics(NucleusStatistic.AREA,
    // MeasurementScale.PIXELS));
    // nuclearStats.addColumn("PERIMETER",
    // collection.getMedianStatistics(NucleusStatistic.PERIMETER,
    // MeasurementScale.PIXELS));
    // nuclearStats.addColumn("FERET",
    // collection.getMedianStatistics(NucleusStatistic.MAX_FERET,
    // MeasurementScale.PIXELS));
    // nuclearStats.addColumn("PATH_LENGTH", collection.getPathLengths());
    // nuclearStats.addColumn("MEDIAN_DIST_BETWEEN_POINTS",
    // collection.getMedianDistanceBetweenPoints());
    // nuclearStats.addColumn("MIN_FERET",
    // collection.getMedianStatistics(NucleusStatistic.MIN_DIAMETER,
    // MeasurementScale.PIXELS));
    //// nuclearStats.addColumn("NORM_TAIL_INDEX",
    // collection.getBorderIndex(BorderTagObject.ORIENTATION_POINT));
    // nuclearStats.addColumn("DIFFERENCE_TO_MEDIAN",
    // collection.getDifferencesToMedianFromPoint(Tag.ORIENTATION_POINT));
    // nuclearStats.addColumn("PATH", collection.getNucleusImagePaths());
    // nuclearStats.export(filename+"."+collection.getName());
    // }
    //
    // public static void exportImagePaths(CellCollection collection, String
    // filename){
    // TableExporter logger = new
    // TableExporter(collection.getFolder()+File.separator+collection.getOutputFolderName());
    ...
    //// }
    //
    // public static void exportSegmentStats(ICellCollection collection, String
    // filename){
    // try {
    // TableExporter logger = new
    // TableExporter(collection.getFolder()+File.separator+collection.getOutputFolderName());
    //
    // IProfileCollection pc =
    ...
    // }
    //
    // public static void exportMediansOfProfile(ICellCollection collection,
    // String filename){
    //
    // try {
    //
    // IProfile normalisedMedian =
    // collection.getProfileCollection(ProfileType.ANGLE).getProfile(Tag.ORIENTATION_POINT,
    // 50);
    // IProfile interpolatedMedian = normalisedMedian.interpolate(
    // (int)collection.getMedianStatistic(NucleusStatistic.PERIMETER,
    // MeasurementScale.PIXELS));
    //
    // TableExporter logger = new
    // TableExporter(collection.getFolder()+File.separator+collection.getOutputFolderName());
    // logger.addColumn("X_POSITION",
    // interpolatedMedian.getPositions(interpolatedMedian.size()).asArray());
