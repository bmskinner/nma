 ...
 * ec.ucdb.br) and Eduardo Rocha Costa (eduardo.rocha at poli.usp.br).
...
public class Hough_Circles implements PlugInFilter {
    ...
    public int radiusMin;      // Find circles with radius grater or equal
                               // radiusMin
    public int radiusMax;      // Find circles with radius less or equal
                               // radiusMax
    public int radiusInc;      // Increment used to go from radiusMin to
                               // radiusMax
    ...
    public int   width;                // Hough Space width (depends on image
                                       // width)
    public int   height;               // Hough Space heigh (depends on image
                                       // height)
    public int   depth;                // Hough Space depth (depends on radius
                                       // interval)
