...
public class GLCM {
	...
	public GLCM(@NonNull final HashOptions options) {
		...
		int[] validAngles = { 0, 45, 90, 135 };
		boolean isValid = Arrays.stream(validAngles).anyMatch(a->a==phi);
		if(!isValid)
	 ...
	 * @return
	 */
	private double[][] calculateGlCM(ImageProcessor ip){
