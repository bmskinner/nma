...
//	}
	...
	/**
	 * Create a collection without elements more than <i>delta</i> proportion away from the median
	 * of the element filtering statistics. Formally, includes all elements of the collection for
	 * which <i>statistic</i> <= (median_statistic * delta) && <i>statistic</i> >= (median_statistic / delta)
	 ...
	 * @return
	 */
	public abstract void removeOutliers(E collection, E failCollection, double delta) throws CollectionFilteringException;
	
	/**
	 * Filter the given collection to retain elements in which the given statistic is within the lower and
	 ...
	 */
	public abstract E filter(E collection, PlottableStatistic stat, double lower, double upper) throws CollectionFilteringException;
