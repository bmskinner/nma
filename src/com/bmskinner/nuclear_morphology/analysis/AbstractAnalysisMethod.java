 ...
 * in the task. Calling {@code fireProgressEvent(long l)} will tell the worker to 
 * update the progress to the given value out of the total amount of 'work' in the task. 
 * 
