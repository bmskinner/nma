...
public class NucleusMeshFaceCoordinate implements MeshFaceCoordinate {
    ...
    /**
     * Constructor. The values should be between 0 and 1 and describe the
     * proportion along the given edge.
     * 
     * @param p1
     *            edge opposite peripheral vertex with lower number
     * @param p2
    ...
    /**
     * Convert the face coordinate into the cartesian coordinates in the given
     * face
     * 
     * @param face
     * @return
    ...
    public IPoint getCartesianCoordinate(@NonNull final MeshFace face) {
        ...
        MeshVertex p1 = usePeripheral ? face.getLowerPeripheralVertex() : face.getLowerInternalVertex();
        MeshVertex p2 = usePeripheral ? face.getHigherPeripheralVertex() : face.getHigherInternalVertex();
        MeshVertex i1 = usePeripheral ? face.getLowerInternalVertex() : face.getLowerPeripheralVertex();
