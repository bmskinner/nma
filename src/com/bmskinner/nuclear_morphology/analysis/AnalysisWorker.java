...
/**
 * This class provides progress and done signalling control for SwingWorker
 * analyses. It provides a consistent process() and done() methods, allowing
 * doInBackground() to be overridden as needed for each worker
 * 
 * @author bms41
 * @since 1.11.4
 *
...
public abstract class AnalysisWorker extends SwingWorker<Boolean, Integer> implements Loggable, ProgressListener {
    ...
    protected static Logger      fileLogger;                  // log to the
                                                              // active dataset
                                                              // log file
    ...
    /**
     * Default constructor using a dataset. If possible, a file logger will be
     * added for the dataset's debug file
     * 
     * @param dataset
     */
    ...
    /**
     * Constructor to use when a dataset has not yet been created. It takes a
     * null dataset, a program logger and a file for logging
     * 
     * @param dataset
     * @param programLogger
     * @param debugFile
