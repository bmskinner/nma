...
public class DefaultMeshImage implements MeshImage {
	...
	/**
	 * Create based on a template mesh and image. Each pixel within the template is
	 * converted to a mesh face coordinate.
	 * 
	 * @param mesh
	 * @param ip   the image to fetch pixels from
	 * @throws MeshImageCreationException
	 */
	public DefaultMeshImage(@NonNull final Mesh mesh, @NonNull final ImageProcessor ip)
			throws MeshImageCreationException {
		template = mesh;
	...
	/**
	 * Find black pixels surrounded by filled pixels, and set them to the average
	 * value. Must have <=3 black pixels touching.
	 * 
	 * @param ip
	 */
	...
	/**
	 * Count the number of black pixels within the 8-connected pixels surrounding
	 * the given pixel
	 * 
