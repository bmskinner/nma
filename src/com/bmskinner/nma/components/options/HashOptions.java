...
import com.bmskinner.nma.analysis.classification.HierarchicalClusterMethod;
...
public interface HashOptions extends Serializable, XmlSerializable {
	...
	String CLUSTER_GROUP_ID_KEY = "CLUSTER_GROUP_ID";
	...
	/**
	 * Remove the given key if present. If the key is used for e.g. String and int,
