...
public interface Nucleus extends CellularComponent, Taggable, Orientable, Comparable<Nucleus> {
	...
	/**
	 * Get a representation of the nucleus name as the name of the image plus the
	 * number of the nucleus. For /P12.tiff nucleus 3 : P12.tiff-3
	 * 
	 * @return
	 */
	...
	/**
	 * Calculate the angle signal centres of mass make with the nucleus centre of
	 * mass and the given border point
	 * 
...
//    void calculateSignalAnglesFromPoint(@NonNull IPoint p);
	...
	/**
	 * Fetch the oriented copy of the nucleus. This will use the landmarks and
	 * priorities defined by the rulesets used when creating the nucleus.
	 * 
