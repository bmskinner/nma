...
public interface ISegmentedProfile extends IProfile {
	...
	/**
	 * Get a copy of the segments in this profile. The order will be the same as the
	 * original segment list. No point type specifiers are available; if you need to
	 ...
	 * merge source of one of the segments in the profile
	 * 
	 * @param id the id
	 ...
	 * closest proportional index that preserves minimum segment lengths. If
	 * segments cannot be properly interpolated, a profile exception will be thrown.
	 * 
	 ...
	 * the profile. The first segment is the segment that starts with index zero or
	 ...
	 * positions. Checks the validity of the operation, and returns false if it is
	 * not possible to perform the update
	 * 
	 ...
	 * end indexes of all segments are increased by the given value, with wrapping
	 * applied.
	 * 
	 * <pre>
	 *  0     5          15                      Index
	 ...
	 * adjusting the segment start and end indexes. Assume a segmented profile like
	 * this:
	 * 
	 * <pre>
	 *  0     5          15                   35   Index
	 ...
	 * </pre>
	 * 
	 * After invoking {@code startFrom(5)}, the profile looks like this:
	 * 
	 * <pre>
	 *  0          10                   30    35
	 *  |----------|--------------------|-----
	 ...
	 * </pre>
	 * 
	 * The new profile starts at index 'newStartIndex' in the original profile. This
	 * means that we must subtract 'newStartIndex' from the segment positions to
	 * make them line up.
	 * 
	 ...
	 * new segments will have the split index as their end and start indexes
	 * respectively.
	 * 
	 ...
	 * @throws ProfileException         if the split would cause a segment to become
	 *                                  too short
	 * @throws IllegalArgumentException if the segment does not contain the
	 *                                  splitting index or the segment is not part
	 *                                  of the profile
	 */
