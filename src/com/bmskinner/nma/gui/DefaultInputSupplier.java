...
public class DefaultInputSupplier implements InputSupplier {
	...
	@Override
	public int requestInt(@NonNull String message, int start, int min, int max, int step)
			throws RequestCancelledException {
		SpinnerNumberModel sModel = new SpinnerNumberModel(start, min, max, step);
	...
	@Override
	public int requestOption(Object[] options, String message) throws RequestCancelledException {
	...
	@Override
	public int requestOptionAllVisible(Object[] options, String message, String title)
			throws RequestCancelledException {
