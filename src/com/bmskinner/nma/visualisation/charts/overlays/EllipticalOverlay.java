 ...
 ******************************************************************************/
package com.bmskinner.nma.visualisation.charts.overlays;
...
public class EllipticalOverlay extends AbstractOverlay implements Overlay, PropertyChangeListener, Serializable {
	...
	/**
	 * Removes the given rectangle and sends an {@link OverlayChangeEvent} to all
	...
	public void paintOverlay(Graphics2D g2, ChartPanel chartPanel) {
		...
		if (ellipse != null && ellipse.isVisible()) {
			...
			double minx = ellipse.getXValue() - ellipse.getXRadius();
