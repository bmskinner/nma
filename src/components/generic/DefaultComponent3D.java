 ...
 * the x axis to trace out a 3D shape. Used for shell simulations 
 * only at the moment.
 * @author bms41
 *
 */
...
//		   We can rotate the point to z=0, and then use the 2D contains() method.
//		   //		    
//		*/
		...
		Point3D rotateX = new Point3D( p.getX(), origin.getY()+newY, 0  ); // rotated the point about x so z=0
