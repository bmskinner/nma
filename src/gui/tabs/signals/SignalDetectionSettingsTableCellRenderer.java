...
import charting.datasets.SignalTableCell;
	 ...
	 * have the same value, colour them light green. Takes into consideration the background
	 * colous from signal groups
	 */
				...
				if(row<table.getModel().getRowCount()-1){
					...
					if(nextRowHeader.equals("Group name")){
						...
						if( signalGroupCount>0 ){
							...
							colour = Color.WHITE; // don't allow consitentcy colours in the signal group line
						}
