...
# Make a zipped tar
tar -czf ${project.basedir}/target/Nuclear_Morphology_Analysis-${project.version}-linux.tar.gz -C ${project.basedir}/target/appimage Nuclear\ Morphology\ Analysis 