...
Open > Open workspace | Select a saved  [workspace ](https://bitbucket.org/bmskinner/nuclear_morphology/wiki/data/Workspaces) in `.wrk` format to open. Note that you can also drag and drop a `.wrk` file into the software to open it.
