...
If you find a bug in the software, you can report it in the [issue tracker](https://bitbucket.org/bmskinner/nuclear_morphology/issues?status=open). No account is needed to report issues.
